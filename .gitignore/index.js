...
client.on("guildMemberAdd", member => {
  member.guild.channels.find("name", "ðŸ“®-arrivÃ©-dÃ©part-ðŸ“®").send(`:smiley: Bienvenue Ã  toi ${member} dans la TEAM SkuSkuRP Passe un bon moment ;) . Il faut Accepter le rÃ©glement pour pouvoir Chatter !  `)
})

client.on("guildMemberRemove", member => {
    member.guild.channels.find("name", "ðŸ“®-arrivÃ©-dÃ©part-ðŸ“®").send(`${member} vient de quitter la TEAM :sob: bonne chance ! `)
})
...
client.on("ready", () => {
    ...
    client.user.setGame("Joue sur le serveur !help pour l'aide ;) :D");
...
client.on('message', async message => { 
    ...
    if(message.content === prefix + "mod") {
      ...
      .setFooter("Commande modÃ©ration - by MYLINEXD ")
      .setTimestamp()
    ...
    if(message.content === prefix + "fun") {
      ...
      .setFooter("Commande modÃ©ration - MYLINEXD")
      .setTimestamp()
  ...
  case "play":
    ...
    message.channel.sendMessage("Tu dois mâ€™indiquer un lien YouTube"); 
